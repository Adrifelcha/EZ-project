...
# Define Simulation Study environment and variables
...
get_Statistics <- function(data){
  ...
  colnames(data_statistics) = c("Person", "Sum Correct","Mean Accuracy", "Mean RT (Correct)", "Variance RT (Correct)")
  return(data_statistics)
}


data_for_jags <- function(data_statistics){
    unique_persons = unique(data_stats$sub)
    nParticipants  = length(unique_persons)
...
Hddm_Data <- function(settings, parameter_set){
  data = sample_data(settings,parameter_set)
