...
sample_data <- function(settings, parameter_set){
      for(i in 1:settings$nP){
          data <- wdmrnd(a = parameter_set$bound[i], 
...
class Hddm_Design:    
    ...
    def sample_parameters(self):
        ...
        self.parameter_set.bound_mean = parameterself.parameter_set.drift_mean = np.random.normal(self.prior.drift_mean_mean, self.prior.drift_mean_sdev)
