...
#- \fancyhead[CO,CE]{EZ Bayesian Hierarchical Drift Diffusion Model}
#- \fancyfoot[CO,CE]{\chaptername}
...
# A function to generate an appropriate output name based on the number of trials and participants
