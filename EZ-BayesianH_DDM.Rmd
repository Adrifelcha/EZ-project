...
Hddm_simStudy <- function(nSim, nParticipants, nTrials, n.chains = 4, 
                          outputFile = "./output_simStudy.RData", 
    ...
    if(runSim){
          ...
          dimnames(simOutput) <- list(NULL, c("true","est","error"), 
                                            c("drift_mean","bound_mean","nondt_mean"))
...
simStudy <- Hddm_simStudy(nSim = 200, nParticipants = 50, nTrials = 150)
```
