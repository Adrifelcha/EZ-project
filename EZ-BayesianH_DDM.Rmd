...
recoveryPlot <- function(x.true, y.estimated, parameterName){
  ...
  abline(0,1, lty=2)
  mtext("Simulated values", 1, line=2.5, cex=0.7)
  mtext(parameterName, 3, line=0.9, cex=1, f=2)
}
```
...
# Smulation study (200 repetitions)

```{r, message=FALSE, results='hide', echo=FALSE, fig.height=2.7, fig.align='center'}
# 50 participants, 150 trials each
simStudy <- Hddm_simStudy(nSim = 200, nParticipants = 50, nTrials = 150, outputFile = "./simStudy_p50t150.RData")
...
recoveryPlot(simStudy[,"true","nondt_mean"],
             ...
             "Group mean nondt")
mtext("50 participants, 150 trials each", side = 3, line =-1.5, outer = TRUE, f=2, col="red3")
```

\vspace{-0.2in}

```{r, message=FALSE, results='hide', fig.height=2.7, fig.align='center', echo=FALSE}
# 50 participants, 50 trials each
simStudy <- Hddm_simStudy(nSim = 200, nParticipants = 150, nTrials = 50, outputFile = "./simStudy_p150t50.RData")
...
recoveryPlot(simStudy[,"true","nondt_mean"],
             simStudy[,"est","nondt_mean"],
             "Group mean nondt")
mtext("50 participants, 50 trials each", side = 3, line =-1.5, outer = TRUE, f=2, col="red3")
```
\vspace{-0.2in}
...
recoveryPlot(simStudy[,"true","nondt_mean"],
             simStudy[,"est","nondt_mean"],
             "Group mean nondt")
mtext("500 participants, 10 trials each", side = 3, line =-1.5, outer = TRUE, f=2, col="red3")
```
