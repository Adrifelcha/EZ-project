...
write_JAGSmodel <- function(priors, modelType, criterion, modelFile){
  ...
  priors.bound_sdInv <- paste("       bound_sdInv ~ dgamma(", priors$bound_sdev_shape,",",priors$bound_sdev_rate,")", sep="")
  priors.nondt_sdInv <- paste("       nondt_sdInv ~ dgamma(", priors$nondt_sdev_shape,",",priors$nondt_sdev_rate,")", sep="")
  priors.drift_sdInv <- paste("       drift_sdInv ~ dgamma(", priors$drift_sdev_shape,",",priors$drift_sdev_rate,")", sep="")
