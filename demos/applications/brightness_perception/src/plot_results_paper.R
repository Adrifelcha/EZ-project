...
###################################################################
png(file = "../../../figures/metaEx_betas_small.png", width = 2, height = 1, units="in",res=300) # Width and height of the plot in inches
...
mtext("Effect of instruction on the drift rate",3,outer=TRUE, f=2, line=.4, cex=0.4)
dev.off()
...
#### Make plot
png(file = "../../../figures/metaEx_driftPreds_small.png", width = 2.5, height = 1.25, units="in",res=300) # Width and height of the plot in inches
...
mtext("Drift rate", 2, line=0.55, cex=0.45, f=2)
...
error.color <- "#E69FF8"
pred.color <- "#BE07C1"
png(file = "../../../figures/metaEx_PostPredChecks.png", width = 2.5, height = 2.5, units="in",res=300) # Width and height of the plot in inches
...
mtext("Posterior predictive checks",3,outer=TRUE, f=2, line=0, cex=0.5)
dev.off()
