...
# Figure 1: Beta posteriors
# PNG version
png(file = here("output", "figures", "demoResults_Brightness_betas.png"), width = 2, height = 1, units="in", res=300)
...
# Figure 2: Predicted drift vs Recovered drift
# PNG version
png(file = here("output", "figures", "demoResults_Brightness_driftPreds.png"), width = 2.5, height = 1.25, units="in", res=300)
par(pty="m", mfrow = c(1,1), mai=c(0,0,0,0), oma= c(1,1.2,1,0.1), bg=NA)
plot_drift_predictions(arrow_length = 0.03, point_size = 0.4)
dev.off()

# PDF version
pdf(file = here("output", "figures", "demoResults_Brightness_driftPreds.pdf"), width = 2.5, height = 1.25)
...
# Figure 3: Posterior predictive checks
# PNG version
png(file = here("output", "figures", "demoResults_Brightness_PostPredChecks.png"), width = 2.5, height = 2.5, units="in", res=300)
...
# PDF version
pdf(file = here("output", "figures", "demoResults_Brightness_PostPredChecks.pdf"), width = 2.5, height = 2.5)
