...
# This R script plots the relevant results from the metaregression model fit for the 
# brightness perception example.
# It generates individual plots of the posterior distributions of the parameters, the 
# predicted drift rate vs the recovered drift rate, and the posterior predictive checks 
# on the accuracy rate, mean RT, and RT variance.
############################################################################################
