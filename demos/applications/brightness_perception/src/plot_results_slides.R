...
############################################################################################
#   P A R T   2:                                       #####################################
#       2 by 2 panel showing model predictions per stimulus configuration      #############
############################################################################################
...
png(file = here("output", "figures", "results-presentation", "slides_BrightnessExample_betas.png"), width = 10, height = 6, , units="in", res=300)
create_beta_plot()
dev.off()
pdf(file = here("output", "figures", "results-presentation", "slides_BrightnessExample_betas.pdf"), width = 10, height = 6)
create_beta_plot()
dev.off()
# Drift predictions
png(file = here("output", "figures", "results-presentation", "slides_BrightnessExample_driftPreds.png"), width = 10, height = 6, units="in", res=300)
create_drift_plot()
dev.off()
pdf(file = here("output", "figures", "results-presentation", "slides_BrightnessExample_driftPreds.pdf"), width = 10, height = 6)
create_drift_plot()
dev.off()

# Posterior predictive check: Accuracy rate
png(file = here("output", "figures", "results-presentation", "slides_BrightnessExample_accRate.png"), width = 10, height = 6, units="in", res=300)
create_accRate_plot()
dev.off()
pdf(file = here("output", "figures", "results-presentation", "slides_BrightnessExample_accRate.pdf"), width = 10, height = 6)
create_accRate_plot()
dev.off()
# Posterior predictive check: Mean RT
png(file = here("output", "figures", "results-presentation", "slides_BrightnessExample_meanRT.png"), width = 10, height = 6, units="in", res=300)
create_meanRT_plot()
dev.off()
pdf(file = here("output", "figures", "results-presentation", "slides_BrightnessExample_meanRT.pdf"), width = 10, height = 6)
create_meanRT_plot()
dev.off()
# Posterior predictive check: Mean RT (log scale)
png(file = here("output", "figures", "results-presentation", "slides_BrightnessExample_logmeanRT.png"), width = 10, height = 6, units="in", res=300)
create_meanRT_log_plot()
dev.off()
pdf(file = here("output", "figures", "results-presentation", "slides_BrightnessExample_logmeanRT.pdf"), width = 10, height = 6)
create_meanRT_log_plot()
dev.off()
# Posterior predictive check: Variance RT
png(file = here("output", "figures", "results-presentation", "slides_BrightnessExample_varRT.png"), width = 10, height = 6, units="in", res=300)
create_varRT_plot()
dev.off()
pdf(file = here("output", "figures", "results-presentation", "slides_BrightnessExample_varRT.pdf"), width = 10, height = 6)
create_varRT_plot()
dev.off()
# Posterior predictive check: Variance RT (log scale)
png(file = here("output", "figures", "results-presentation", "slides_BrightnessExample_logvarRT.png"), width = 10, height = 6, units="in", res=300)
create_varRT_log_plot()
dev.off()
pdf(file = here("output", "figures", "results-presentation", "slides_BrightnessExample_logvarRT.pdf"), width = 10, height = 6)
create_varRT_log_plot()
dev.off()


#####################################
# 2x2 panel showing model predictions per stimulus configuration
#####################################
png(file = here("output", "figures", "results-presentation", "slides_BrightnessExample_predictions.png"), width = 10, height = 6, units="in", res=300)
create_predictions_plot()
dev.off()
pdf(file = here("output", "figures", "results-presentation", "slides_BrightnessExample_predictions.pdf"), width = 10, height = 6)
create_predictions_plot()
dev.off()