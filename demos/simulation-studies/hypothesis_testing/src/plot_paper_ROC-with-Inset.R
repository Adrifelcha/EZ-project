...
postscript(here("output", "figures", "appendix_HypothesisTesting_ROC.eps"), horizontal = FALSE, onefile = FALSE, paper = "special",
           width = 3.5, height = 3)
makeROCPlot()
dev.off()

png(here("output", "figures", "appendix_HypothesisTesting_ROC.png"), width = 3.5, height = 3, units = "in", res = 300)
makeROCPlot()
dev.off()

pdf(here("output", "figures", "appendix_HypothesisTesting_ROC.pdf"), width = 3.5, height = 3)
makeROCPlot()
dev.off()