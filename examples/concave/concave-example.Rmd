...
#layout(mat = matrix(c(1,1,1,2,2,2,3,3,3,0,4,4,5,5,0), nrow = 5, byrow = FALSE))
#layout.show(n = 15)
par(pty="m", mai=c(0.1,0,0,0), oma= c(3.2,7,2.5,0.5))
...
for(k in 1:5){
  ...
  mtext(paste("Condition", k), 2, f=2, line=1.5, cex=0.9)
  mtext("Accuracy rate", 2, line=2.5, cex=0.8) 
  if(k==1){
    mtext("Accuracy rate", f=2, line=.5, cex=0.7,)
    mtext("Qualitative change in Convexity", 2, f=2, line=-2, cex=0.7, col="gray35")}
  if(k==2){mtext("Quantitative change in Convexity", 2,  f=2, line=-1, cex=0.7, col="gray35")}
  if(k==3){mtext("Qualitative change in Concavity", 2,  f=2, line=-1.5, cex=0.7, col="gray35")}
  if(k==4){mtext("Quantitative change in Concavity", 2, f=2, line=0, cex=0.7, col="gray35")}
  if(k==5){mtext("No change at all", 2, f=2, line=.5, cex=0.7, col="gray35")
           mtext("Participant",1,line=1.7,cex=0.8)}
}
...
for(k in 1:5){
  ...
  mtext("Mean RT (secs)", 2, line=2.5, cex=0.8) 
  if(k==1){mtext("Mean RT (secs)", f=2, line=.5, cex=0.7)}
  if(k==5){mtext("No change at all", f=2, line=.5, cex=0.7, col="gray35")
    mtext("Participant",1,line=1.7,cex=0.8)}
...
for(k in 1:5){
  ...
  mtext("RT variance (log-scale)", 2, line=2.5, cex=0.8)
  if(k==1){
    mtext("RT variance (logs)", f=2, line=.5, cex=0.7)}
  if(k==5){mtext("No change at all", f=2, line=.5, cex=0.7, col="gray35")
    mtext("Participant",1,line=1.7,cex=0.8)}
