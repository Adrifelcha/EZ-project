...
# Paleta violeta
r1 <- round(seq(91,234, length.out=9),0)
g1 <- round(seq(25,46, length.out=9),0)
b1 <- round(seq(99,255, length.out=9),0)

# Paleta verde
r2 <- round(seq(25,64, length.out=9),0)
g2 <- round(seq(99,255, length.out=9),0)
b2 <- round(seq(46,118, length.out=9),0)

# Paleta azul
r3 <- round(seq(31,72, length.out=9),0)
g3 <- round(seq(61,150, length.out=9),0)
b3 <- round(seq(99,255, length.out=9),0)

# Paleta amarillo
r4 <- round(seq(99,255, length.out=9),0)
g4 <- round(seq(83,215, length.out=9),0)
b4 <- round(seq(25,66, length.out=9),0)

# Paleta rojo
r5 <- round(seq(99,180, length.out=9),0)
g5 <- round(seq(25,66, length.out=9),0)
b5 <- round(seq(25,255, length.out=9),0)

x <- c(1:5,NA,7:11,NA,13:17,NA,19:23,NA,25:29,NA,31:35,NA,37:41,NA,43:47,NA,49:53)
valid <- x[!is.na(x)]
```
...
par(mai=c(0,0,0,0))
plot(4.5, 1, col="white", ylim=c(0,1), xlim=c(0,46),ann=F,axes=F)
axis(1,seq(1,45,length.out=9),paste("sub =",1:9))
axis(2,seq(0,1,0.1), seq(0,1,0.1),las=1)
legend("topright", c("Observed data"), pch=8, col="black", bty = "n")
legend("topright", c("", paste("Cond ", 1:5)), lwd=2, col=c("white"), bty = "n")
mtext("Participant",1,line=2,f=2,cex=1.2)
points(ezdata$acc_rate, pch=8, cex=0.8)
# Start by drawing the Confidence Intervals
arrows(1,theta_CI[1,1],1,theta_CI[2,1], col=color.theta1(1), angle = 90, lwd=2)
arrows(1,theta_CI[2,1],1,theta_CI[1,1], col=color.theta1(1), angle = 90, lwd=2)
arrows(2,theta_CI[1,2],2,theta_CI[2,2], col=color.theta2(1), angle = 90, lwd=2)
arrows(2,theta_CI[2,2],2,theta_CI[1,2], col=color.theta2(1), angle = 90, lwd=2)
arrows(3,theta_CI[1,3],3,theta_CI[2,3], col=color.theta3(1), angle = 90, lwd=2)
arrows(3,theta_CI[2,3],3,theta_CI[1,3], col=color.theta3(1), angle = 90, lwd=2)
arrows(4,theta_CI[1,4],4,theta_CI[2,4], col=color.theta4(1), angle = 90, lwd=2)
arrows(4,theta_CI[2,4],4,theta_CI[1,4], col=color.theta4(1), angle = 90, lwd=2)
arrows(5,theta_CI[1,5],5,theta_CI[2,5], col=color.theta5(1), angle = 90, lwd=2)
arrows(5,theta_CI[2,5],5,theta_CI[1,5], col=color.theta5(1), angle = 90, lwd=2)
arrows(6,theta_CI[1,6],6,theta_CI[2,6], col=color.theta6(1), angle = 90, lwd=2)
arrows(6,theta_CI[2,6],6,theta_CI[1,6], col=color.theta6(1), angle = 90, lwd=2)
# Add random posterior samples for each theta_i to help visualize the distribution
rnd_iter <- sample(1:(nrow(theta)*ncol(theta)),1000)
points(runif(rnd_iter,0.95,1.05),theta_dataF[rnd_iter,1], col=color.theta1(0.05), pch=16, cex=0.8)
points(runif(rnd_iter,1.95,2.05),theta_dataF[rnd_iter,2], col=color.theta2(0.05), pch=16, cex=0.8)
points(runif(rnd_iter,2.95,3.05),theta_dataF[rnd_iter,3], col=color.theta3(0.05), pch=16, cex=0.8)
points(runif(rnd_iter,3.95,4.05),theta_dataF[rnd_iter,4], col=color.theta4(0.05), pch=16, cex=0.8)
points(runif(rnd_iter,4.95,5.05),theta_dataF[rnd_iter,5], col=color.theta5(0.05), pch=16, cex=0.8)
points(runif(rnd_iter,5.95,6.05),theta_dataF[rnd_iter,6], col=color.theta6(0.05), pch=16, cex=0.8)
# Identify the posterior means (black) and the observed y/x (red)
for(i in 1:6){
    lines(c(i-0.1,i+0.1),rep(theta_mean[i],2),lwd=2)
    lines(c(i-0.1,i+0.1),rep(z[i],2),lwd=2, col="red")
}
```
