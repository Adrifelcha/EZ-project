...
- **Stimulus intensity**: Conditions 1-16 and 34-49 had more black pixels; conditions 18-33 and 51-66 had more white, and conditions 17 and 50 were ambiguous and will not be used here because they can't provide accuracy measures.
...
ez_summaries <- function(subset){
  ...
  return(data.frame("nTrials" = nrow(subset),
                  ...
                  # Arbitrary scale of stimulus intensity | 0 is 50/50 black and white 
                    "Xs"  = ((cond-1) %% 33 - 16)/5))
}
```
...
percentiles <- apply(drift,2, quantile, probs=c(0.25,0.95))
