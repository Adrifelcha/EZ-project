---
title: "EZBHDDM - Metaregression example"
...
###################################################################
png(file = "../../figures/percEx_betas.png", width = 7, height = 4, units="in",res=300) # Width and height of the plot in inches
par(mfrow = c(1,2), mai=c(0.6,0.6,0.7,0.2), oma= c(0,0,0,0), bg=NA)
line.color    <- "#DC9303"
...
abline(v=0,lty=2)
mtext("Effect of instruction on the drift rate",3,outer=TRUE, f=2, line=-2, cex=1.5)
...
errors <- rbind(errors_acc,c(NA,NA),errors_spd)
#### Make plot
png(file = "../../figures/percEx_driftPreds.png", width = 7, height = 4, units="in",res=300) # Width and height of the plot in inches
...
error.color <- "#E69FF8"
pred.color <- "#BE07C1"
png(file = "../../figures/percEx_accPostPred.png", width = 7, height = 4, units="in",res=300) # Width and height of the plot in inches
...
pred.color <- "#00A437"
point.size <- 0.9
png(file = "../../figures/percEx_meanRTpostPred.png", width = 7, height = 4, units="in",res=300) # Width and height of the plot in inches
par(pty="m", mfrow = c(1,1), mai=c(0.9,0.6,0.5,0.1), oma= c(0,0,0,0), bg=NA)
    plot(full_x,est.rtMean.Full, col="white", ann=F, axes=F, ylim=c(0.2,1), 
         xaxs = "i", yaxs = "i", xlim=c(-3.5,10.3))
    polygon(c(-3.5,3.4,3.4,-3.5),c(0,0,6,6),col = acc.bckg, border = acc.bckg, lwd = 1, lty = "solid")
...
###################################################################
png(file = "../../figures/percEx_meanRTpostPred_log.png", width = 7, height = 4, units="in",res=300) # Width and height of the plot in inches
par(pty="m", mfrow = c(1,1), mai=c(0.9,0.6,0.5,0.1), oma= c(0,0,0,0), bg=NA)
...
error.color <- "#8CE0FF"
pred.color <- "#095B79"
png(file = "../../figures/percEx_varRTpostPred.png", width = 7, height = 4, units="in",res=300) # Width and height of the plot in inches
par(pty="m", mfrow = c(1,1), mai=c(0.9,0.6,0.5,0.1), oma= c(0,0,0,0), bg=NA)
    plot(full_x,est.rtVar.Full, col="white", ann=F, axes=F, ylim=c(0,0.4),
         xaxs = "i", yaxs = "i", xlim=c(-3.5,10.3))
    polygon(c(-3.5,3.4,3.4,-3.5),c(0,0,6,6),col = acc.bckg, border = acc.bckg, lwd = 1, lty = "solid")
...
#######################################################################
png(file = "../../figures/percEx_varRTpostPred_log.png", width = 7, height = 4, units="in",res=300) # Width and height of the plot in inches
par(pty="m", mfrow = c(1,1), mai=c(0.9,0.6,0.5,0.1), oma= c(0,0,0,0), bg=NA)
