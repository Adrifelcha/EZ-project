...
lines(density(beta3), lwd=4, col=line.color)
axis(1,seq(0,1.6,0.4),seq(0,1.6,0.4),cex.axis=0.8)
axis(2,seq(0,2,0.5),seq(0,2,0.5),las=2)
mtext("Density",side=2,line=2.15,cex=1.2)
mtext(expression(paste(beta[3])),side=1,line=2,cex=1.2)
mtext("Effect on slope", f=2, cex=1.5)
abline(v=0,lty=2)
mtext("Effect of instruction on the drift rate",3,outer=TRUE, f=2, line=-2, cex=2)
...
mtext(expression(paste(beta[4])),side=1,line=2,cex=1.2)
axis(1,seq(0,1.6,0.4),seq(0,1.6,0.4))
mtext("Main effect", f=2, cex=1.5)
abline(v=0,lty=2)
dev.off()
...
```{r}
png(file = "../../figures/percEx_predictions.png", width = 10, height = 6, units="in",res=300) # Width and height of the plot in inches
