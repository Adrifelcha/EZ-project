...
##### Noiseless predictions for the statistics sampled
...
legend("topleft",c("Predicted drift rates","Mean drifts recovered","Error bars"), col=line.color, lwd=c(4,NA,NA), bty = "n", bg = "gray98", cex=0.8)
x.marker <- -3.1
points(x.marker,5.35, col=error.color, pch=16)
arrows(x.marker,4.93, x.marker, 5.13, length=0.05, angle=90, code=3, col=error.color)
box(col="black")
...
acc.meanRTcor <- c(df$mean_rt[1:16],NA,df$mean_rt[17:32])
spd.meanRTcor <- c(df$mean_rt[33:48],NA,df$mean_rt[49:64])
# Concatenate RT-correct variance with a 'jump', across speed/accuracy conditions
acc.varRTcor <- c(df$variance_rt[1:16],NA,df$variance_rt[17:32])
spd.varRTcor <- c(df$variance_rt[33:48],NA,df$variance_rt[49:64])
```
...
mtext("Stimulus configuration", 1, line=3)
legend("left",c("95% C.I.","Mean prediction","Observed"), col=c(error.color,pred.color,NA), lwd=c(8,4,NA), bty = "n", bg = "gray98", cex=0.8)
x.marker <- -3.1
points(x.marker,0.74, col=data.color, pch=8)
box(col="black")
...
mtext("Accuracy instructions", 3, line=1)
mtext("Stimulus configuration", 1, line=3)
legend("topleft",c("95% C.I.","Mean prediction","Observed"), col=c(error.color,pred.color,NA), lwd=c(8,4,NA), bty = "n", bg = "gray98", cex=0.8)
x.marker <- -3.1
points(x.marker,0.875, col=data.color, pch=8)
box(col="black")
...
legend("topleft",c("95% C.I.","Mean prediction","Observed"), col=c(error.color,pred.color,NA), lwd=c(8,4,NA), bty = "n", bg = "gray98", cex=0.8)
x.marker <- -3.1
points(x.marker,0.338, col=data.color, pch=8)
box(col="black")
