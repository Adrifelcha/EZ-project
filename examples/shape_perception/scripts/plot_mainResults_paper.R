...
source("./plottingColors.R")
source("./loadSamples.R")

png(file = "../../../figures/mlr_QualandChangeTypeEffcts_small.png", width = 6, height = 4, units="in",res=300) # Width and height of the plot in 
par(bg=NA, mai=c(0.45,0.1,0,0.05), oma= c(0,0.3,2,0))
...
mtext("Quantitative change effect", cex=0.9, f=2, side=3, line=0.1)
...
mtext("Change in concavity effect", cex=0.9, f=2, side=3, line=0.1)
...
mtext("Quantitative change in", cex=0.9, f=2, side=3, line=0.5)
mtext("concavity effect", cex=0.9, f=2, side=3, line=-0.7)
