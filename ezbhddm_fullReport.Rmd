...
```{r}
ss11 <- HDDM_runSims(nParticipants = nT1, nTrials = nT1, nDatasets = nSim, Show=TRUE)
ss12 <- HDDM_runSims(nParticipants = nT1, nTrials = nT2, nDatasets = nSim, Show=TRUE)
ss13 <- HDDM_runSims(nParticipants = nT1, nTrials = nT3, nDatasets = nSim, Show=TRUE)
ss14 <- HDDM_runSims(nParticipants = nT1, nTrials = nT4, nDatasets = nSim, Show=TRUE)
ss15 <- HDDM_runSims(nParticipants = nT1, nTrials = nT5, nDatasets = nSim, Show=TRUE)

ss21 <- Hddm_simStudy(nSim = nSim, nParticipants = nT2, nTrials = nT1)
ss22 <- Hddm_simStudy(nSim = nSim, nParticipants = nT2, nTrials = nT2)
ss23 <- Hddm_simStudy(nSim = nSim, nParticipants = nT2, nTrials = nT3)
ss24 <- Hddm_simStudy(nSim = nSim, nParticipants = nT2, nTrials = nT4)
ss25<- Hddm_simStudy(nSim = nSim, nParticipants = nT2, nTrials = nT5)

ss31 <- Hddm_simStudy(nSim = nSim, nParticipants = nT3, nTrials = nT1)
ss32 <- Hddm_simStudy(nSim = nSim, nParticipants = nT3, nTrials = nT2)
ss33 <- Hddm_simStudy(nSim = nSim, nParticipants = nT3, nTrials = nT3)
ss34 <- Hddm_simStudy(nSim = nSim, nParticipants = nT3, nTrials = nT4)
ss35 <- Hddm_simStudy(nSim = nSim, nParticipants = nT3, nTrials = nT5)

ss41 <- Hddm_simStudy(nSim = nSim, nParticipants = nT4, nTrials = nT1)
ss42 <- Hddm_simStudy(nSim = nSim, nParticipants = nT4, nTrials = nT2)
ss43 <- Hddm_simStudy(nSim = nSim, nParticipants = nT4, nTrials = nT3)
ss44 <- Hddm_simStudy(nSim = nSim, nParticipants = nT4, nTrials = nT4)
ss45 <- Hddm_simStudy(nSim = nSim, nParticipants = nT4, nTrials = nT5)

ss51 <- Hddm_simStudy(nSim = nSim, nParticipants = nT5, nTrials = nT1)
ss52 <- Hddm_simStudy(nSim = nSim, nParticipants = nT5, nTrials = nT2)
ss53 <- Hddm_simStudy(nSim = nSim, nParticipants = nT5, nTrials = nT3)
ss54 <- Hddm_simStudy(nSim = nSim, nParticipants = nT5, nTrials = nT4)
ss55 <- Hddm_simStudy(nSim = nSim, nParticipants = nT5, nTrials = nT5)
```
