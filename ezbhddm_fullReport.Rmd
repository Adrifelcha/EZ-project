...
```{r}
simH <- HDDM_runSims(nParticipants = 100, nTrials = 200, nDatasets = 1, modelType = "hierarchical", forceSim = TRUE)
#simT <- HDDM_runSims(nParticipants = 100, nTrials = 200, nDatasets = 1, modelType = "ttest")
```
...
## 300 trials - 30 participants - 200 iter

```{r, results='hide',message=FALSE}
simStudyH1 <- HDDM_runSims(nParticipants = 30, nTrials = 300, nDatasets = 200, Show=TRUE)
```
...
simStudyH2 <- HDDM_runSims(nParticipants = 300, nTrials = 30, nDatasets = 200, Show=TRUE)
```
...
```{r}
simM <- HDDM_runSims(nParticipants = 100, nTrials = 200, nDatasets = 1, modelType = "metaregression", forceSim = TRUE)
```
