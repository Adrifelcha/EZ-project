assign('B', get(load("./results_40x40/simStudy_B.RData")))
assign('B2', get(load("./results_40x40/simStudy_B1.RData")))
assign('B4', get(load("./results_40x40/simStudy_B2.RData")))

#estimates <- list("B" = B, "B1" = B1, "B2" = B2, "B3" = B3, "B4" = B4, "B5" = B5)
estimates <- list("B" = B, "B2" = B2, "B4" = B4)
look.at <- c("B", "B2", "B4")
levelsM <- 1000
m <- seq(0,2,length.out=levelsM)
m2 <- seq(0,30,length.out=levelsM)
