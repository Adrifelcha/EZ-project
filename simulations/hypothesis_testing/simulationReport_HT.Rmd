...
```{r}
betaDiff <- HDDM_simFixedEffect(nParticipants = 40, nTrialsPerCondition = 160, nDatasets = 1000, beta.effect = 0.5, 
                         priors = NA, n.chains = 4, Show = TRUE, forceSim = FALSE, fromPrior = TRUE)

y <- HDDM_simFixedEffect(nParticipants = 40, nTrialsPerCondition = 160, nDatasets = 1000, beta.effect = 0, 
